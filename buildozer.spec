...
# ==============================================================================
# SEÇÃO CORRIGIDA: Removido o travamento explícito do python3 para evitar conflito com hostpython3
# ==============================================================================
requirements = python3,kivy,sqlite3,flask,jinja2,pyjnius,android,plyer,numpy==1.26.4,scikit-learn==1.3.2
