...
# (list) Application requirements (Crucial para Flask, WebView e a IA IsolationForest)
requirements = python3,kivy,sqlite3,flask,jinja2,pyjnius,android,plyer,numpy,scikit-learn
